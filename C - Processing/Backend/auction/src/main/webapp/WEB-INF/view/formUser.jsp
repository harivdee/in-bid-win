...
<html>
    ...
    <body>
        ...
        <f:form cssClass="form-group" id="formUser" 
            ...
            <div class="form-group col-md-4 mb-3">
                ...
                <f:input cssClass="form-control is-valid" id="validationServer01" path="fname"/>
            ...
            <div class="form-group col-md-4 mb-3">
                ...
                <f:input path="lname" cssClass="form-control is-valid" id="validationServer02"/>
            ...
            <div class="form-group col-md-4 mb-3">
                <div class="form-group">
                    ...
                    <f:input cssClass="form-control is-valid" id="inputEmail" path="email"/>
            ...
            <div class="form-group col-md-4 mb-3">
                ...
                <div class="input-group">
                    ...
                    <f:input cssClass="form-control is-invalid" id="validationServerUsername" path="username"/>
